...
int specialWeapon_detect_hit(struct specialWeapon_s *this,
                             fighter_p fighter, struct shot_s *shots,
                             struct shot2_s *ashots);

/* return 0 means: special weapon is still active */
int specialWeapon_move(struct specialWeapon_s *this, fighter_p fighter,
		       struct shot_s *shots, struct shot2_s *ashots);
